...
export class Favorites {
  ...
  async add(username){
    try{
      ...
      if(userExists){
        throw new Error('Utilizador já cadastrado')
      }
...
export class FavoritesView extends Favorites {
  ...
  createRow(){
    ...
    tr.innerHTML = `
          <td class="user">
            <img src="https://github.com/maykbrito.png" alt="Imagem do Mayk Brito">
  ...
  createEmptyRow(){
    ...
    tr.innerHTML = `
        <td id="empty" colspan="4">
          <div>
            <img src="./assets/Estrela.png" alt="Ílustração de uma estrela sorrindo">
